...
export class MjmlAccordion extends BodyComponent<{}> {
        ...
        <ColumnChildWrapper com={this}>
          <table {...attributes}>
            <tbody>
              ...
              {this.props.data.children?.map((item, index) => <BlockRenderer key={index} data={item} parent={this.props.data} containerWidth={this.props.containerWidth} attributes={childrenAttr} />)}
