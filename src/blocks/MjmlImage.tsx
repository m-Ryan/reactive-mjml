...
export class MjmlImage extends BodyComponent<{}> {
  ...
  getContentWidth() {
    ...
    return min([box, width]) as any as string;
  }
  ...
  renderImage() {
    ...
    const img = `
      ...
      height: height && (height === 'auto' ? height : parseInt(height, 10).toString()),
